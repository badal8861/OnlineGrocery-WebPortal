...
public class PaymentEntity {
	...
	public PaymentEntity(int id, String name, long accno, long password, long ccno, int cccvv, String ccexpiry,
			long dbno, int dbcvv, String dbexpiry, String upiid, int upipin, int custid, double amount, int orderId) {
		super();
		this.id = id;
		this.name = name;
		this.accno = accno;
	...
	public String toString() {
		return "PaymentEntity [id=" + id + ", name=" + name + ", accno=" + accno + ", password=" + password + ", ccno="
				+ ccno + ", cccvv=" + cccvv + ", ccexpiry=" + ccexpiry + ", dbno=" + dbno + ", dbcvv=" + dbcvv
				+ ", dbexpiry=" + dbexpiry + ", upiid=" + upiid + ", upipin=" + upipin + ", custid=" + custid
